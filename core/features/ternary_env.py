...
def compute_avg_homoatomic_dist_by_site_shortest_dist(connections, R, M, X):
    ...
    R_avg_homoatomic_dist_by_shortest_dist = R_total_homoatomic_dist_by_shortest_dist / len(
        element_to_site_labels[R]
    )
    M_avg_homoatomic_dist_by_shortest_dist = M_total_homoatomic_dist_by_shortest_dist / len(
        element_to_site_labels[M]
    )
    X_avg_homoatomic_dist_by_shortest_dist = X_total_homoatomic_dist_by_shortest_dist / len(
        element_to_site_labels[X]
    )
    return (
