...
def postprocess_merge_dfs(
    ...
    cn_ternary_avg_avg_df = df_util.prefix_columns(cn_ternary_avg_avg_df, "CN_AVG_")
    cn_ternary_avg_min_df = df_util.prefix_columns(cn_ternary_avg_min_df, "CN_MIN_")
    cn_ternary_avg_max_df = df_util.prefix_columns(cn_ternary_avg_max_df, "CN_MAX_")
