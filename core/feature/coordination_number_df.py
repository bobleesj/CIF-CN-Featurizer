...
import core.feature.coordination_number as cn_featurizer
import time
    ...
    data.update(
        {
            ...
            "central_atom_to_center_of_mass_dist": [metrics["distance_to_center"]],
            "number_of_edges": [metrics["number_of_edges"]],
            "number_of_faces": [metrics["number_of_faces"]],
            "shortest_distance_to_face": [metrics["shortest_distance_to_face"]],
            "shortest_distance_to_edge": [metrics["shortest_distance_to_edge"]],
            "volume_of_inscribed_sphere": [metrics["volume_of_inscribed_sphere"]],
