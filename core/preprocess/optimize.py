...
def optimize_CIF_rad_binary(
    ...
    con1 = {
        "type": "eq",
        "fun": partial(constraint_binary_1, shortest_AA=shortest_distances_pair["AA"]),
    }
    con2 = {
        "type": "eq",
        "fun": partial(constraint_binary_2, shortest_BB=shortest_distances_pair["BB"]),
    }
    con3 = {
        "type": "eq",
        "fun": partial(constraint_binary_3, shortest_AB=shortest_distances_pair["AB"]),
    }
...
def optimize_CIF_rad_ternary(
    ...
    for label, dist in shortest_distances_pair.items():
        constraints[label] = {
            "type": "eq",
            "fun": partial(constraint_ternary, shortest_distance=dist, labels=label),
        }
