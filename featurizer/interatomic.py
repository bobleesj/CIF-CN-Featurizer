...
def get_interatomic_binary_df(filename,
    ...
    interatomic_binary_data = {
        ...
        "A": [A],
        "B": [B],
        "AA Dist.": [interatomic_distA_A],
        "BB Dist.": [interatomic_distB_B],
        "AB Dist.": [interatomic_distA_B],
        "Asize": [A_CIF_rad],
        "Bsize": [B_CIF_rad],
        "Asize_by_Bsize": [Asize_by_Bsize],
        "distA_A_by_byAsize": [distA_A_by_byAsize],
        "distB_B_by_byBsize": [distB_B_by_byBsize],
        "distA_B_by_byAsizebyBsize": [distA_B_by_byAsizebyBsize],
        "A_CIF_rad_refined.": [A_CIF_rad_refined],
        "A_CIF_rad_refined.": [B_CIF_rad_refined],
        "percent_diff_A by 100": [percent_diff_A],
        "percent_diff_B by 100": [percent_diff_B],
        "interatomic_A_A_minus_ref_diff": [interatomic_A_A_minus_ref_diff],
        "interatomic_B_B_minus_ref_diff": [interatomic_B_B_minus_ref_diff],
        "interatomic_A_B_minus_ref_diff": [interatomic_A_B_minus_ref_diff],
        "Packing efficiency": [packing_efficiency],
        "least_sq_percent_diff": [obj_value]
    }
...
def get_interatomic_ternary_df(filename,
    ...
    interatomic_ternary_data = {
        ...
        "distR_R_by2_byRsize": [distR_R_by2_byRsize],
        "distM_M_by2_byMsize": [distM_M_by2_byMsize],
        "distX_X_by2_byXsize": [distX_X_by2_byXsize],
        "distR_M_byRsizebyMsize": [distR_M_byRsizebyMsize],
        "distM_X_byMsizebyXsize": [distM_X_byMsizebyXsize],
        "distR_X_byRsizebyXsize": [distR_X_byRsizebyXsize],
        "R_CIF_rad_refined": [R_CIF_rad_refined],
        "M_CIF_rad_refined": [M_CIF_rad_refined],
        "X_CIF_rad_refined": [X_CIF_rad_refined],
        "percent_diff_R_by_100": [percent_diff_R],
        "percent_diff_M_by_100": [percent_diff_M],
        "percent_diff_X_by_100": [percent_diff_X],
        "interatomic_R_R_minus_ref_diff": [interatomic_R_R_minus_ref_diff],
        "interatomic_M_M_minus_ref_diff": [interatomic_M_M_minus_ref_diff],
        "interatomic_X_X_minus_ref_diff": [interatomic_X_X_minus_ref_diff],
        "interatomic_R_M_minus_ref_diff": [interatomic_R_M_minus_ref_diff],
        "interatomic_M_X_minus_ref_diff": [interatomic_M_X_minus_ref_diff],
        "interatomic_R_X_minus_ref_diff": [interatomic_R_X_minus_ref_diff],
        "Packing efficiency": [packing_efficiency],
        "least_sq_percent_diff": [obj_value]
    }
